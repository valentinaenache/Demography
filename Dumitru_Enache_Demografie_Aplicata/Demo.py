...
tabel = pd.read_csv("C:\\Users\\teodo\\OneDrive\\Desktop\\Demo2019.csv", index_col=0)
...
if q > 1:
    Graf.biplot(z, zg, y, regiuni)
for i in range(q):
    Graf.distributie(z,i,y,regiuni)
...
# Aplicarea modelului pe test (Demo 2014)
set_testare = pd.read_csv("C:\\Users\\teodo\\OneDrive\\Desktop\\Demo2014.csv", index_col=0)
